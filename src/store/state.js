export default {
  ...
  experience: [
    ...
    },
    {
      ...
      todos: [
        ...
        "Gia công mới website cho khách hàng",
        "Gia công theme wordpress"
      ],
      tags: ["HTML5", "CSS3", "Jquery", "Wordpress", "Responsive", "Transition"]
    },
    {
      ...
      todos: [
        "Chiệu trách nhiệm chỉnh sửa và gia công các trang web Wordpress và Shopify.",
  ...
  portfolio: {
    vue: [
      {
        project: "vue-countdown",
        heading: "Vue Countdown",
        tags: ["Vuejs", "components"]
      },
      {
        project: "vue-todo-list-simple",
        heading: "Todo List",
        tags: ["VueCLI", "Vux"]
      },
      {
        project: "vue-todo-list-firebase",
        heading: "Todo List with Firebase",
        tags: ["VueCLI", "Vuex", "Vuexfire", "firebase-realtime-database"]
      },
      {
        project: "vue-weather-app-simple",
        heading: "Weather App",
        tags: ["VueCLI", "Vux", "API"]
      },
      {
        project: "vue-weather-app-one-call-api",
        heading: "Weather App One Call API",
        tags: ["VueCLI", "Vux", "API"]
      },
      {
        project: "vue-events-list-firebase",
    ...
    nodejs: [
      {
        project: "nodejs-blog-simple",
        heading: "Nodejs - Blog Cơ Bản",
        tags: ["nodejs", "express", "sql", "pug-template-engine", "sass"]
      }
    ],
    typescript: [
      {
        project: "typescript-quanlynhanvien-simple",
        heading: "TypeScript - Quản lý nhân viên Cơ Bản",
        tags: ["typescript"]
      }
    ]
  }
